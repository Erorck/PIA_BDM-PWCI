...
<body>
    ...
    <form action="../includes/register_inc.php" method="post" enctype="multipart/form-data" id="crearcuent">
        ...
        <div class="mb-4">
            ...
            <input type="password" class="form-control" name="passwordC" id="contraConfirm" >
        </div>
        <div class="mb-4">
            <input type="password" class="form-control" name="userType" id="userType" hidden="true" value="UR">
        </div>
