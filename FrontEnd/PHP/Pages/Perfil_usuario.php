      ...
      ?>
        ...
        ?>
          ...
          <div class="perfil-usuario-avatar">
            ...
            ?>
            <button type="button" class="boton-avatar" id="profile_pic_form" style="display: none">
          ...
          <button type="button" class="boton-portada" id="banner_pic_form" style="display: none">
          ...
          <form action="../includes/user_profile_inc.php" method="post" id="datosusuario" enctype="multipart/form-data">
            <div class="perfil-usuario-footer">
              ...
              <div id="btn_tools" class="herramientas">
                <button type="button" id="btn_mod" class="boton-redes facebook"><i class="fas fa-wrench"></i></button>
                <button type="button" id="btn_cancel" style="display: none" class="boton-redes cancel"><i class="fas fa-xmark"></i></button>
              </div>
