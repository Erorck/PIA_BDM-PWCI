    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <form class="d-flex">
          ...
          <button class="btn btn-link" type="submit"><i class="fas fa-user"></i></button>
        </form>
      </div>
    </div>
  </nav>
    ...
    <section class="seccion-perfil-usuario">
        <div class="perfil-usuario-header">
            <div class="perfil-usuario-portada">
                <div class="perfil-usuario-avatar">
                    <img src="../../Elementos/Jordi.jpg" alt="img-avatar">
        ...
        <div class="perfil-usuario-body">
            <div class="perfil-usuario-bio">
                <h3 class="titulo">Jordi el niño ...</h3>
                <p class="texto">Joven emprendedor mexicano, con grandes sueños de superacion y actualmente estudiante en la NASA</p>
            </div>
            <form action="" id="datosusuario">
            <div class="perfil-usuario-footer" >
                <ul class="lista-datos">
                    <li><input id="exampleusername" type="text" name="Nombre" placeholder="Nombre de Usuario" class="Nombre-usuario" ></li>
                    <li><input id="examplecorreo" type="email" name="Correo" placeholder="Correo" class="input-100" ></li>
                    <li><input id="examplecontra" type="password" name="Contraseña" placeholder="Contraseña" class="input-cont" ></li>
                </ul>
                <ul class="lista-datos">
                    <li><input id="examplename" type="text" name="NombreComp" placeholder="Nombre Completo" class="Nombre-completo"></li>
                    <li><input id="exampletel" type="tel" name="telefono" placeholder="Telefono" class="input-100"></li>
                    <button class="btn-outline-success" id="btn_change" type="submit">Guardar cambios</button>
                    <br>
                </ul>
            </div>
          </form>
