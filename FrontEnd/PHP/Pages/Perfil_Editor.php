    ...
    <section class="seccion-perfil-usuario">
      ...
      <div class="perfil-usuario-body">
        <div class="perfil-usuario-bio">
          <h3 class="titulo"><?php echo $_SESSION["user"]["USER_ALIAS"] ?></h3>
        </div>
        <div class="perfil-usuario-footer">
          <ul class="lista-datos">
            <li><i class="fas fa-phone-alt"></i> Telefono: +52 <?php echo $_SESSION["user"]["PHONE_NUMBER"] ?></li>
            <li><i class="fas fa-envelope"></i> Correo: <?php echo $_SESSION["user"]["EMAIL"] ?></li>
          </ul>
          <ul class="lista-datos">
            <li><i class="fad fa-user-alt"></i> <?php echo $_SESSION["user"]["FULL_NAME"] ?></li>
            <li><i class="fad fa-briefcase"></i> Editor en jefe de Good Old Times</li>
          </ul>
        </div>
        <div class="herramientas">
          <a href="" class="boton-redes facebook"><i class="fas fa-wrench"></i></a>
        </div>
      </div>
    </section>
