...
BEGIN
 ...
 /*#######################################
	...
	THEN
		SELECT `REPORT_NUMBER`, `AUTOR_SIGN`,  
        `EVENT_STREET`, `EVENT_NEIGHBOURHOOD`, `EVENT_CITY`, `EVENT_COUNTRY`, 
        `HEADER`, `REPORT_DESCRIPTION`, `CONTENT`, `LIKES`, `THUMBNAIL`, EVENT_DATE, beautifyDatetimeLarge(EVENT_DATE) as blEVENT_DATE,
        beautifyDatetimeSmall(EVENT_DATE) as bsEVENT_DATE, `PUBLICATION_DATE`,
        `CREATION_DATE`, `CREATED_BY_ID`, `CREATED_BY_NAME`,
		`LAST_UPDATE_DATE`, `UPDATED_BY_ID`, `UPDATED_BY_NAME`, `REPORT_STATUS`
        FROM v_news_detailed
	...
	THEN
		SELECT `REPORT_NUMBER`, `AUTOR_SIGN`,  
        `EVENT_STREET`, `EVENT_NEIGHBOURHOOD`, `EVENT_CITY`, `EVENT_COUNTRY`, 
        `HEADER`, `REPORT_DESCRIPTION`, `CONTENT`, `LIKES`, `THUMBNAIL`, EVENT_DATE, 
        EVENT_DATE, beautifyDatetimeLarge(EVENT_DATE) as blEVENT_DATE,
        beautifyDatetimeSmall(EVENT_DATE) as bsEVENT_DATE, `PUBLICATION_DATE`,
        `CREATION_DATE`, `CREATED_BY_ID`, `CREATED_BY_NAME`,
		`LAST_UPDATE_DATE`, `UPDATED_BY_ID`, `UPDATED_BY_NAME`, `REPORT_STATUS`
        FROM v_news_detailed      
