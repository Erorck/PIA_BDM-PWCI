...
CREATE TABLE `images` (
  ...
  `IMAGE_STATUS` char(2) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'P' COMMENT 'Estado actual del material [P-Publico  E-Eliminado]',
  `REPORT_ID` int NOT NULL COMMENT 'Id de la noticia a la que pertence el material',
  PRIMARY KEY (`ID_IMAGE`),
  KEY `FK_IMAGE_REPORT` (`REPORT_ID`),
  CONSTRAINT `FK_IMAGE_REPORT` FOREIGN KEY (`REPORT_ID`) REFERENCES `news_reports` (`REPORT_ID`)
