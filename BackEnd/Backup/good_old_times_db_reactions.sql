...
CREATE TABLE `reactions` (
  ...
  `LIKED` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Bandera que indica la reaccion del usuario a la nota',
  ...
  KEY `FK_REACTION_REPORT` (`REPORT_ID`),
  CONSTRAINT `FK_REACTION_REPORT` FOREIGN KEY (`REPORT_ID`) REFERENCES `news_reports` (`REPORT_ID`),
  CONSTRAINT `FK_REACTION_USER` FOREIGN KEY (`USER`) REFERENCES `users` (`ID_USER`)
