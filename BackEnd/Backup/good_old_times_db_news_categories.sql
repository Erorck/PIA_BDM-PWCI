...
CREATE TABLE `news_categories` (
  ...
  KEY `FK_N_CA_CATEGORY` (`CATEGORY`),
  CONSTRAINT `FK_N_CA_CATEGORY` FOREIGN KEY (`CATEGORY`) REFERENCES `categories` (`CATEGORY_NAME`),
  CONSTRAINT `FK_N_CA_REPORT` FOREIGN KEY (`REPORT_ID`) REFERENCES `news_reports` (`REPORT_ID`)
